...
// Provider for all patient locations (doctor view)
class DoctorLocationsState {
...
class DoctorLocationsNotifier extends StateNotifier<DoctorLocationsState> {
  final LocationRepository repository;
  final String doctorId;

  DoctorLocationsNotifier({required this.repository, required this.doctorId})
      : super(const DoctorLocationsState());

  Future<void> loadLocations() async {
    try {
      state = state.copyWith(isLoading: true);
      final locations = await repository.getAllPatientLocations(doctorId);
